...
namespace qmapcontrol
{
    ...
    public:
         ...
         */
        GeometryPointImageScaled(const PointWorldCoord& point_coord,
        ...
        /// GeometryPointImageScaled(const GeometryPointImageScaled&) = delete; @todo re-add once
        /// MSVC supports default/delete syntax.

        //! Disable copy assignment.
        /// GeometryPointImageScaled& operator=(const GeometryPointImageScaled&) = delete; @todo
    ...
    private:
        //! Disable copy constructor.
        GeometryPointImageScaled(const GeometryPointImageScaled&); /// @todo remove once MSVC
                                                                   /// supports default/delete
                                                                   /// syntax.

        //! Disable copy assignment.
        GeometryPointImageScaled& operator=(const GeometryPointImageScaled&); /// @todo remove once
                                                                              /// MSVC supports
                                                                              /// default/delete
                                                                              /// syntax.
