...
{
    class QMAPCONTROL_EXPORT ProjectionEquirectangular : public Projection
    {
    public:
        //! Constuctor.
        /*!
        ...
        /// ProjectionEquirectangular(const ProjectionEquirectangular&) = delete; @todo re-add once
        /// MSVC supports default/delete syntax.

        //! Disable copy assignment.
        /// ProjectionEquirectangular& operator=(const ProjectionEquirectangular&) = delete; @todo
        ...
        /*!
         * Converts a world coorindate point (longitude/latitude) into the pixel point for a given
         * zoom.
         * @param point_coord The world coordinate point to convert (longitude/latitude).
         * @param zoom The zoom level.
         * @return the converted world pixel point.
         */
        PointWorldPx toPointWorldPx(const PointWorldCoord& point_coord,
                                    const int& zoom) const final;

        /*!
         * Converts a world pixel point into the coorindate point (longitude/latitude) for a given
         * zoom.
         * @param point_px The world pixel point to convert.
         * @param zoom The zoom level.
         * @return the converted world coorindate point (longitude/latitude).
         */
        PointWorldCoord toPointWorldCoord(const PointWorldPx& point_px,
                                          const int& zoom) const final;

    private:
        //! Disable copy constructor.
        ProjectionEquirectangular(const ProjectionEquirectangular&); /// @todo remove once MSVC
                                                                     /// supports default/delete
                                                                     /// syntax.

        //! Disable copy assignment.
        ProjectionEquirectangular& operator=(const ProjectionEquirectangular&); /// @todo remove
                                                                                /// once MSVC
                                                                                /// supports
                                                                                /// default/delete
                                                                                /// syntax.
