...
namespace qmapcontrol
{
    ...
    public:
        ...
        /// MapAdapterOSM(const MapAdapterOSM&) = delete; @todo re-add once MSVC supports
        /// default/delete syntax.

        //! Disable copy assignment.
        /// MapAdapterOSM& operator=(const MapAdapterOSM&) = delete; @todo re-add once MSVC supports
        /// default/delete syntax.
    ...
    private:
        //! Disable copy constructor.
        MapAdapterOSM(const MapAdapterOSM&); /// @todo remove once MSVC supports default/delete
                                             /// syntax.

        //! Disable copy assignment.
        MapAdapterOSM& operator=(const MapAdapterOSM&); /// @todo remove once MSVC supports
                                                        /// default/delete syntax.
    };
}
