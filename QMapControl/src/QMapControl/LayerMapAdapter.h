...
namespace qmapcontrol
{
    ...
    public:
        ...
        /// LayerMapAdapter(const LayerMapAdapter&) = delete; @todo re-add once MSVC supports
        /// default/delete syntax.

        //! Disable copy assignment.
        /// LayerMapAdapter& operator=(const LayerMapAdapter&) = delete; @todo re-add once MSVC
        /// supports default/delete syntax.

        //! Destructor.
        virtual ~LayerMapAdapter() {
