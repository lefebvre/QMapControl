...
namespace qmapcontrol
{
    ...
    public:
         ...
         */
        MapAdapterGoogle(const GoogleLayerType& layer_type = GoogleLayerType::MAPS,
                         QObject* parent = 0);

        //! Disable copy constructor.
        /// MapAdapterGoogle(const MapAdapterGoogle&) = delete; @todo re-add once MSVC supports
        /// default/delete syntax.

        //! Disable copy assignment.
        /// MapAdapterGoogle& operator=(const MapAdapterGoogle&) = delete; @todo re-add once MSVC
    ...
    private:
        //! Disable copy constructor.
        MapAdapterGoogle(const MapAdapterGoogle&); /// @todo remove once MSVC supports
                                                   /// default/delete syntax.

        //! Disable copy assignment.
        MapAdapterGoogle& operator=(const MapAdapterGoogle&); /// @todo remove once MSVC supports
                                                              /// default/delete syntax.
    };
}
