...
namespace qmapcontrol
{
    ...
    public:
        ...
        /// Projection(const Projection&) = delete; @todo re-add once MSVC supports default/delete
        /// syntax.

        //! Disable copy assignment.
        /// Projection& operator=(const Projection&) = delete; @todo re-add once MSVC supports
         ...
         */
        virtual PointWorldPx toPointWorldPx(const PointWorldCoord& point_coord,
                                            const int& zoom) const = 0;
         ...
         */
        virtual PointWorldCoord toPointWorldCoord(const PointWorldPx& point_px,
                                                  const int& zoom) const = 0;
    ...
    private:
        ...
        //! Disable copy assignment.
        Projection& operator=(const Projection&); /// @todo remove once MSVC supports default/delete
                                                  /// syntax.
    };
