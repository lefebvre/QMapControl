...
namespace qmapcontrol
{
    ...
    public:
         ...
         */
        LayerESRIShapefile(const std::string& name,
                           const int& zoom_minimum = 0,
                           const int& zoom_maximum = 17,
                           QObject* parent = 0);

        //! Disable copy constructor.
        /// LayerESRIShapefile(const LayerESRIShapefile&) = delete; @todo re-add once MSVC supports
        /// default/delete syntax.

        //! Disable copy assignment.
        /// LayerESRIShapefile& operator=(const LayerESRIShapefile&) = delete; @todo re-add once
        /// MSVC supports default/delete syntax.

        //! Destructor.
        virtual ~LayerESRIShapefile() {
         ...
         * @param disable_redraw Whether to disable the redraw call after the ESRI Shapefile is
         * added.
         */
        void addESRIShapefile(const std::shared_ptr<ESRIShapefile>& esri_shapefile,
         ...
         * removed.
         */
        void removeESRIShapefile(const std::shared_ptr<ESRIShapefile>& esri_shapefile,
                                 const bool& disable_redraw = false);

        /*!
         * Removes all ESRI Shapefile objects from this Layer.
         * @param disable_redraw Whether to disable the redraw call after all ESRI Shapefiles are
         * removed.
         */
