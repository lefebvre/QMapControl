...
namespace qmapcontrol
{
    ...
    public:
         ...
         */
        ProjectionSphericalMercator() {
        } /// = default; @todo re-add once MSVC supports default/delete syntax.

        //! Disable copy constructor.
        /// ProjectionSphericalMercator(const ProjectionSphericalMercator&) = delete; @todo re-add
        /// once MSVC supports default/delete syntax.

        //! Disable copy assignment.
        /// ProjectionSphericalMercator& operator=(const ProjectionSphericalMercator&) = delete;
        /// @todo re-add once MSVC supports default/delete syntax.
    ...
    private:
        //! Disable copy constructor.
        ProjectionSphericalMercator(const ProjectionSphericalMercator&); /// @todo remove once MSVC
                                                                         /// supports default/delete
                                                                         /// syntax.

        //! Disable copy assignment.
        ProjectionSphericalMercator&
        operator=(const ProjectionSphericalMercator&); /// @todo remove once MSVC supports
