...
namespace qmapcontrol
{
     ...
     * See the specialised layer types to display each type of stuff (eg: MapAdapters, Geometries,
     * etc...).
     *
    ...
    public:
        ...
        /// Layer& operator=(const Layer&) = delete; @todo re-add once MSVC supports default/delete
        /// syntax.
         ...
         * @param controller_zoom The current controller zoom.
         */
        virtual void mousePressEvent(const QMouseEvent* mouse_event,
                                     const PointWorldCoord& mouse_point_coord,
                                     const int& controller_zoom) const = 0;
