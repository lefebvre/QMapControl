...
namespace qmapcontrol
{
    ...
    public:
        ...
        /// MapAdapterYahoo(const MapAdapterYahoo&) = delete; @todo re-add once MSVC supports
        /// default/delete syntax.

        //! Disable copy assignment.
        /// MapAdapterYahoo& operator=(const MapAdapterYahoo&) = delete; @todo re-add once MSVC
    ...
    private:
        //! Disable copy constructor.
        MapAdapterYahoo(const MapAdapterYahoo&); /// @todo remove once MSVC supports default/delete
                                                 /// syntax.

        //! Disable copy assignment.
        MapAdapterYahoo& operator=(const MapAdapterYahoo&); /// @todo remove once MSVC supports
                                                            /// default/delete syntax.
    };
}
