...
namespace qmapcontrol
{
    ...
    /*!
     * Use this derived MapAdapter to display maps from Tiled Map servers
    ...
    public:
         ...
         * std::shared_ptr<MapAdapterTile>
         * mat(std::make_shared<MapAdapterTile>(QUrl("http://192.168.8.1/img/img_cache.php/%zoom/%x/%y.png"),
         ...
         * @param invert_y Whether the y-axis tile needs to be inverted (ie: y-axis tiles start at
        ...
        /// MapAdapterTile(const MapAdapterTile&) = delete; @todo re-add once MSVC supports
        /// default/delete syntax.

        //! Disable copy assignment.
        /// MapAdapterTile& operator=(const MapAdapterTile&) = delete; @todo re-add once MSVC
         ...
         */
        virtual QUrl
        tileQuery(const int& x, const int& y, const int& controller_zoom) const override;

    private:
        //! Disable copy constructor.
        MapAdapterTile(const MapAdapterTile&); /// @todo remove once MSVC supports default/delete
                                               /// syntax.

        //! Disable copy assignment.
        MapAdapterTile& operator=(const MapAdapterTile&); /// @todo remove once MSVC supports
                                                          /// default/delete syntax.

        /// Whether the y-axis tile needs to be inverted (ie: y-axis tiles start at bottom-left,
        /// instead of top-left).
